        ...
        >
          ...
          <PageText>
            <PageTextColumn>
              ...
              estetycznego oraz przywrócenie odpowiedniej mechaniki narządu
              żucia. Dzięki przywróceniu kompletnego uzębienia znów zaczniesz
              cieszyć się pięknym uśmiechem.
              <br></br>
              <br></br>
              Opogramowanie <strong>DDS-PRO</strong> przeznaczone jest do
              wsparcia procesu diagnostycznego, przygotowania do zabiegu
              chirurgii ortognatycznej; przygotowania do zabiegu implantologii
              stomatologicznej wizualizacji 3D struktur kostnych oraz
              zaplanowaniu i symulacji zabiegu implantoprotetycznego.
              <br></br>
              ...
              wewnątrzustnego lub skanu tomograficznego wycisku szczęki lub
              żuchwy to można go zaimportować do oprogramowania{" "}
              <strong>DDS-Pro</strong>. Gwarantuje to większą dokładność
              rzeczywistego odwzorowania, niż badanie 3D pacjenta. Importowany
              plik musi mieć format STL. Następnie szablon drukujemy na drukarce
              3D i po etapie sterylizacji jest gotowy do wykorzystania.
            </PageTextColumn>
            <PageTextColumn>
              Wykonujemy zabiegi podniesienia dna zatoki szczękowej metodą
              otwartą oraz zamkniętą. Rozwiązania protetyczne stosowane wraz z
              implantami:
              <List>
                <ListText>
              ...
              Każdy, kto chce cieszyć się z pięknego uśmiechu i komfortu,
              powinien wybrać implanty – dzięki nim można komfortowo jeść, śmiać
              ...
              szwajcarskie <strong>PREMIUM (Thommen Medical).</strong> <br></br>
              <br></br>
