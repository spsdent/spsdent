      ...
      <Container>
        ...
        >
          ...
          <PageText>
            <PageTextColumn>
              ...
              <List>
                <ListText>
                  ...
                  szybki i bezpieczny sposób przy minimalnej dawce
                  promieniowania zrobić jeszcze na fotelu (nawet w trakcie
                  zabiegu) zdjęcię pojedynczego zęba.
                </ListText>
                <ListText>
            ...
            <PageTextColumn>
              Badania tomografii komputerowej wykonywane są za pomocą
              nowoczesnego tomografu{" "}
              <strong>Kodak Carestream 8100 3D.CS 8100</strong> to najbardziej
              innowacyjny na świecie tomograf CBCT i pantomograf.
              <br></br>
              ...
              tomograficznego zębów Zdrowie i bezpieczeństwo naszych pacjentów
              są dla nas najważniejsze, dlatego też korzystamy z najbardziej
              zaawansowanego technologicznie sprzętu, który pozwala na
              wykonywanie badań ze zredukowaną aż o 75%-90% dawką promieniowania
              rentgenowskiego (
              <strong>Inteligentny System Kontroli Dawki</strong>
              ).
              <br></br> <br></br>
              ...
              zastosowanie maksymalnej ochrony płodu przed rozwiązaniem. UWAGA!
              W celu wykonania zdjęcia rentgenowskiego niezbędne jest posiadanie
