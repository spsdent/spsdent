        ...
        >
          ...
          <PageText>
            <PageTextColumn>
              ...
              ustnej. Postawowe zabiegi z tej dziedziny związane są z
              profilaktyką próchnicy zębów oraz leczeniem wszelkiego rodzaju
              ubytków. Pacjenci, którzy systematycznie poddają się stomatologii
              zachowawczej efektywnie wzmacniają struktury zębów oraz
              uodparniają się na działanie bakterii.
              <br></br>
              <br></br>
              <strong>Piękny i zdrowy uśmiech dla każdego</strong>
              <br></br>
              Prawidłowa higiena jamy ustnej jest niezwykle ważnym elementem
              codziennej troski o zdrowie. Nawet osoby, które szczególnie dbają
              o swoje zęby poprzez regularne szczotkowanie, płukanie oraz
              stosowanie nici dentystycznych powinny przynajmniej raz na pół
              roku zgłaszać się do gabinetu dentystycznego na wizytę
              profilaktyczną. Tylko w taki sposób można na bieżąco kontrolować
              stan swojego uzębienia oraz odpowiednio wcześnie wykryć
              występujące ubytki.
              <br></br>
              <br></br>
              ...
              nasze codzienne poczucie komfortu. Warto więc pamiętać o
              regularnych wizytach w gabinecie dentystycznym oraz stomatologii
              zachowawczej, która pomoże skutecznie zapobiec poważniejszym
              infekcjom jamy ustnej oraz chorobom zębów.<br></br>
              <br></br>
              <strong>
                Dodatkowo należy zdawać sobie sprawę, że dolegliwości zębów lub
                dziąseł mogą z czasem przyczynić się do powstania innych
                schorzeń organizmu w tym chorób serca, nerek lub stawów.
              </strong>
            </PageTextColumn>
            <PageTextColumn>
              ...
              <List>
                ...
                <ListText>
                  usuwanie problemów związanych z nadwrażliwością oraz
                  krwawieniem dziąseł
                </ListText>
                <ListText>
              ...
              <strong>
                {" "}
                Stomatologia zachowawcza obejmuje także wszelkie zabiegi
                dotyczące leczenia ubytków zębowych, które powstały na skutek
                próchnicy, między innymi:
              </strong>
              <List>
