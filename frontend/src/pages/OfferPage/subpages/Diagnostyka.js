        ...
        >
          ...
          <PageText>
            <PageTextColumn>
              ...
              jednoznacznie możemy okreslić kolor zębów Pacjenta jak również
              kolor uzupełnienia protetycznego.
              <br></br>
              <br></br>
              ...
              powierzchniowe. Niezwykle trudno rozpoznać zmiany próchnicowe w
              ich początkowym stadium oraz te, które umiejscowione są na
              powierzchniach stycznych zębów i w głębokich bruzdach zębów
              tylnych. Najczęściej diagnozuje się próchnicę już w stadium
              rozwiniętym i nieodwracalnym, przez co konieczne jest wdrożenie
              leczenia zachowawczego. <br></br>
              ...
              nowotworowym. Dodatkowo sprawdza stan węzłów chłonnych, gdyż
              często toczące się stany zapalne zębów objawiają się zmianami w
              ich anatomii.
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              Panorama to najczęściej wykonywany rodzaj zdjęcia
              stomatologicznego. Przedstawia ono szczękę i żuchwę wraz ze
              wszystkimi strukturami, tj. zatokami, stawami skroniowo-żuchwowymi
              oraz kośćmi. Powinno się je wykonywać raz na 2-3 lata lub
              częściej, jeśli są ku temu wskazania medyczne. Warto gromadzić
              takie zdjęcia, gdyż są skarbnicą wiedzy o zmianach, które zachodzą
            ...
            <PageTextColumn>
              ...
              powierzchniach stycznych zębów. Próchnica na zdjęciu
              radiologicznym uwidacznia się jako swoiste przejaśnienie na
              tkankach twardych zęba.
              <br></br>
              <br></br>
              ...
              czemu można zdobyć wiedzę o wadach zgryzu, zmianach
              chorobotwórczych różnego typu, kamieniach tworzących się w
              śliniankach oraz niewidocznych zębach.
              <br></br>
              <br></br>
              ...
              <List>
                ...
                <ListText>
                  tomografia wiązki stożkowej CBTC (cone beam computed
                  tomography)
                </ListText>
                <ListText>badanie 3D</ListText>
              </List>
              Nie należy bać się diagnostyki radiologicznej. Poziom
              promieniowania stosowany przez specjalistyczne urządzenia do
              efektywnej ekspozycji jest niski. Samo badanie nie jest dla
              Pacjenta uciążliwe, a pozwala uzyskać precyzyjne zdjęcie w bardzo
              krótkim czasie. Diagnostyka stomatologiczna umożliwia postawienie
              pełnej i prawidłowej diagnozy dotyczącej stanu zdrowia jamy ustnej
              Pacjenta. Zastosowanie nowoczesnych technik wiąże się z kosztami,
              jednak dzięki profilaktyce możemy uniknąć znacznie większych
