      ...
      >
        ...
        <PageText>
          <PageTextColumn>
            ...
            nielubianego przez pacjentów etapu pobierania wycisku za pomocą masy
            wyciskowej - skrócenie czasu oczekiwania na uzupełnienie protetyczne
            (koronę, most, licówkę) - zwiększona dokładność i estetyka
            wykonywanej pracy protetycznej.
            <br></br>
            <br></br>
            Skaner zastępuje tradycyjny wycisk wykonywany za pomocą plastycznych
            mas protetycznych. Wirtualny „wycisk” daje znaczenie większe
            poczucie komfortu pacjentom którzy często miewają nieprzyjemne
            odczucia przy stosowaniu tradycyjnej metody wyciskowej. <br></br>{" "}
            <br></br>
          ...
          <PageTextColumn>
            ...
            obrazu, jest on wysyłany do specjalistycznej placówki protetycznej.
            W ciągu zaledwie kilku minut od pobrania i wysłania wycisku można
            zacząć projektowanie pracy końcowej, co znacznie skraca czas
            wykonania ale także zwiększa precyzyjność uzupełnienia
            ...
            protetyczne wykonane za pomocą technologii <strong>CAD/CAM</strong>{" "}
            są dokładniejsze, szczelniejsze i trwalsze w porównaniu do
            uzupełnień wykonanych metodą tradycyjną. <br></br>
            <br></br>
